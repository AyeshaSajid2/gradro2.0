...
final List<VegetableDetail> vegetableDetails = [
    ...
    VegetableDetail(
      ...
      shortSpec: '45 cm',
      description: 'Bring the soil to fine tilth and pits should be dug at spacing of 45 cm',
    ...
    VegetableDetail(
      ...
      shortSpec: '60 cm',
      description: 'Bring the soil to fine tilth and pits should be dug at spacing of 60 cm',
